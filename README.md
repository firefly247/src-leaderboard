...
- data/competition_events.csv: 160미만, 160이상, 160~200처럼 관리되는 대회 종목 목록입니다.
- data/competition_records.csv: 회원별 대회 참가 연도·종목과 금·은·동메달 수를 저장합니다. 같은 대회의 여러 종목에 출전해도 대회 참석 횟수는 한 번으로 집계합니다.
...
- 대회 탭은 `대회 출석왕 TOP 5`, `메달 명예의 전당 TOP 5`, 클럽 총 메달, 연도·대회별 현황을 제공합니다. 메달 순위는 금메달, 은메달, 동메달 순으로 비교합니다.
